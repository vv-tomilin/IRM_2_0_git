...
(function ($) {
    ...
    function SlickGrid(container, data, columns, options) {
        ...
        function resizeCanvas() {
            ...
            if (!scrollbarDimensions || !scrollbarDimensions.width || true) {
        ...
        function getCellFromNode(cellNode) {
			/** ATVISE Fix for cell with no slick-cell class ... otherwise wrong error will be thrown**/
			if(cellNode.className.indexOf("slick-cell") < 0)
				return;
